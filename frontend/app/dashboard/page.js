...
import { Users, Briefcase, FileCheck, XCircle, Loader2, Search } from "lucide-react"
...
export default function DashboardPage() {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin size-8 text-primary" /></div>;
  }
    ...
    <div className="flex-1 space-y-4 p-8 pt-6 pb-20">
      <div className="flex items-center justify-between space-y-2">
        ...
        <div className="flex items-center space-x-2">
           <Button onClick={() => router.push('/jobs')} className="bg-black text-white hover:bg-zinc-800 dark:bg-white dark:text-black">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">All time tracked jobs</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Success rate: {stats.total > 0 ? Math.round((stats.offer / stats.total) * 100) : 0}%</p>
          </CardContent>
        </Card>
